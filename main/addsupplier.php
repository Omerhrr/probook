...
<center><h4><i class="icon-plus-sign icon-large"></i> Add Vendors</h4></center>
<hr>
<div id="ac">
<span>Vendor's Name:</span><input type="text" style="width:265px; height:30px;" name="name" required/><br>
