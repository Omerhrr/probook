...
<form action="admin_accountrecievables.php?branch=" method="get">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<?php
	$results= $db->prepare("SELECT DISTINCT name as cname FROM c_ledger WHERE branch = '{$_SESSION['BRANCH']}'");
	...
	<tbody>
			...
			<td><?php echo formatMoney($row['debit'] - $row['credit'],true); ?></td>
			</tr>
			<?php
				}
			?>
