...
// query
$sql = "INSERT INTO deposit (bank_name,account_name,account_number,date,description,debit,credit,branch,reciept) VALUES (:a,:b,:c,:d,:e,:f,:credit,:g,:h)";
$q = $db->prepare($sql);
$q->execute(array(':a'=>$bank_name,':b'=>$account_name,':c'=>$account_number,':d'=>$b, ':e'=>$c,':f'=>$d,':credit'=>$credit,':g'=>$branch,':h'=>$inv));
