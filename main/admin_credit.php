...
?>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Credits
			</div>
			<ul class="breadcrumb">
...
<form action="admin_credit.php?branch=0" method="get">
...
Credit report from&nbsp;<?php echo $_GET['branch'] ?>
</div>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$d1=$_GET['branch'];
				$result = $db->prepare("SELECT * FROM purchases JOIN purchases_item on purchases_item.invoice = purchases.invoice_number WHERE purchases.branch = :a ORDER BY purchases_item.invoice DESC");
      ...
      <td><?php echo formatMoney($row['cost'],true); ?></td>
        ...
        <th></th>
				...
				<?php
				$d1=$_GET['branch'];
				$resultas = $db->prepare("SELECT sum(cost) from purchases_item JOIN purchases on purchases_item.invoice = purchases.invoice_number WHERE purchases.branch = :b");
