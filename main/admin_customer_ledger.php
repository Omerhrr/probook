...
<form action="admin_customer_ledger.php?branch=" method="get">
...
Customer Ledger from&nbsp;<?php echo $_GET['branch'] ?>
</div>
</div>
<div class="card-body">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<?php
	$branch=$_GET['branch'];
	$results= $db->prepare("SELECT DISTINCT name as cname FROM c_ledger WHERE branch = '{$branch}'");
	...
	<tbody>
			...
			<?php
				...
				$branch=$_GET['branch'];
				$result = $db->prepare("SELECT *,sum(debit) as debit, sum(credit) as credit FROM c_ledger WHERE branch = '{$branch}'  and name = '{$cname}' ");
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			include('../connect.php');
				...
				$result = $db->prepare("SELECT *,invoice FROM c_ledger WHERE  branch = :a   ORDER BY date DESC");
		...
		<!--td>
			...
			<a  href="previews.php?iv=<?php echo $row['invoice']; ?>&cname=<?php echo $_GET['cname']; ?>"title="Click to generate reciept"><button class="btn btn-danger"><i class="icon-list"></i> Receipt</button></a>


			<a class="Journals" rel="facebox" href="addcustomer_journals.php?iv=<?php echo $row['invoice']; ?>" id=""  title="Click to issue a journal"><button class="btn btn-warning"><i class="icon-edit"></i> Journals</button></a>
