...
<form action="savepostwithdrawal.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Create Withdrawal</h4></center>
<hr>
...
<option></option>
<option>Being Amount Withdrawn</option>
