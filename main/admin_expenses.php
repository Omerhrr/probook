...
?>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Expenses
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="">Expenses Summary</li>
			</ul>
...
<form action="admin_expenses.php?branch=0" method="get">
...
Expenses report from&nbsp;<?php echo $_GET['branch'] ?>
</div>
</div>
</div>
<div class="card-body">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$d1=$_GET['branch'];
				$result = $db->prepare("SELECT * FROM expenselist WHERE branch = :a ORDER BY date DESC");
        ...
        <th>Total Expenses</th>
			...
			<tr>
				...
				<?php
				$d1=$_GET['branch'];
				$resultas = $db->prepare("SELECT sum(amount) from expenselist WHERE branch = :b ");
