...
<select name="category" style="width:260px; height:30px;">
	...
	?>
		<option><?php echo $row['Expenses_category']; ?></option>
		
	<?php
	}
	?>
</select><br>
<span>PV number:<br> </span><input type="text" style="width:265px; height:30px;" name="pv" /><br>
<span>Remarks:<br> </span><input type="text" style="width:265px; height:30px;" name="remarks" /><br>
<span>Amount : </span><input type="text" id="txt1" style="width:265px; height:30px;" name="amount" onkeyup="sum();" Required><br>
