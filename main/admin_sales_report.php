...
<form action="admin_sales_report.php?branch=''&d1=0&d2=0" method="get">
...
<?php echo $_GET['branch'] ?>  Sales Report from &nbsp;    <?php echo $_GET['d1'] ?>&nbsp;to&nbsp;<?php echo $_GET['d2'] ?>
</div>
</div>
</div>
<div class="card-body">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT * FROM sales WHERE branch = :branch AND date BETWEEN :a and :b ORDER BY date DESC ");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->prepare("SELECT sum(amount) FROM sales WHERE branch = :branch AND date BETWEEN :a and :b ORDER BY date DESC");
