...
<span>Branch Email :</span><input type="email" style="width:265px; height:30px;" name="email" /><br>
<span>Branch Address :</span><input type="text" style="width:265px; height:30px;" name="address" /><br>
<span>Branch Contact :</span><input type="text" style="width:265px; height:30px;" name="contact" /><br>
<span>Branch Motto: </span><input type="text" style="width:265px; height:30px;" name="motto" /><br>
