...
<form action="admin_supplier_ledger.php?branch=" method="get">
...
Supplier Ledger from&nbsp;<?php echo $_GET['branch'] ?>
</div>
</div>
<div class="card-body">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<?php
	$branch =$_GET['branch'];
	$results= $db->prepare("SELECT DISTINCT name as sname FROM s_ledger WHERE branch = '{$branch}'");
	...
	<tbody>
			...
			<?php
				...
				$result = $db->prepare("SELECT *,sum(debit) as debit, sum(credit) as credit FROM s_ledger WHERE branch = '{$branch}' and name = '{$sname}' ");
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			include('../connect.php');
				...
				$result = $db->prepare("SELECT *,invoice FROM s_ledger WHERE  branch = :a   ORDER BY date DESC");
